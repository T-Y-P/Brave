...
require_once("component/".$prefix."List.php");
...
$(function(){
	...
	/*prevent music api abuse*/ static $music_api_verification='gAAAAABiASwKLsBPutLwuRn0xkJvGGq9SFfcPP-FXtgMkRpw0HFReOpRnanrVxCcNi9qLVpSlxqPJnMMC0ZnVBeYDtS_4INuJw==';
